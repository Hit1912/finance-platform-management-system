...
const ExpensePieChart = (props: { dateRange?: DateRangeType }) => {
  ...
  return (
    <Card className="glass-card border border-border/50 shadow-md rounded-[24px] gsap-reveal overflow-hidden h-full">
      <CardHeader className="pb-2 pt-8 px-8">
        <CardTitle className="text-xl font-black text-foreground tracking-tighter">Expenses Breakdown</CardTitle>
        <CardDescription className="text-xs font-semibold text-muted-foreground uppercase tracking-widest opacity-60">Spending by category</CardDescription>
      </CardHeader>
      <CardContent className="h-[313px] px-8">
    ...
    <CardContent className="h-[313px]">
      <div className="w-full flex items-center justify-center">
        <div className="relative w-[200px] h-[200px]">
          <Skeleton className="rounded-full w-full h-full bg-muted" />
